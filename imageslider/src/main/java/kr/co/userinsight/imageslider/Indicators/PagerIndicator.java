package kr.co.userinsight.imageslider.Indicators;
...
public class PagerIndicator extends LinearLayout implements ViewPagerEx.OnPageChangeListener {
    ...
    private DataSetObserver dataChangeObserver = new DataSetObserver() {
        ...
        public void onChanged() {
            ...
            mItemCount = count;
            if (mItemCount <= 1) {
                mPager.setCurrentItem((mItemCount + 1) * 20 + mPager.getCurrentItem(), true);
            } else {
                mPager.setCurrentItem(20 + mPager.getCurrentItem(), true);
            }
        }
